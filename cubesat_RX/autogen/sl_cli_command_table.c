...
static const sl_cli_command_info_t cli_cmd__set_id = \
  SL_CLI_COMMAND(cli_set_device_id,
                 "Set device ID (1-4) to NVM3",
                  "device_id (1-4)" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT8, SL_CLI_ARG_END, });
